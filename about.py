...
LINK_GROUPS = [
    ...
    ("Модели перевода", [
        ("🤖", "Коллекция моделей", "Модели и датасеты Khakas Translation на Hugging Face", MODELS_URL),
    ...
    ("Хакасская клавиатура", [
        ...
        ("💻", "Клавиатура на компьютер", "Раскладка хакасской клавиатуры для ПК", KEYBOARD_DESKTOP_URL),
    ]),
    ("Сервисы", [
