...
CORPUS_ROWS = [
    ...
    # заимствование: одно и то же слово стоит и в хакасской, и в русской колонке
    {"kjh": "Мин телефон алғам.", "ru": "Я купил телефон."},
]

# Строк с «чазыда» больше, чем примеров в подборке: на них проверяется лимит.
CORPUS_ROWS += [
    {"kjh": f"Чазыда {n} киик кӧрдім.", "ru": f"Я увидел в степи {n} косуль."}
    for n in range(1, 13)
]
...
DICT_ROWS = [
    ...
    # статья без перевода-глоссы: в датасете такие есть
    {
        "word": "сӧс",
        "semgloss": "  ",
        "field1": "<b>сӧс</b> <i>сущ.</i> слово",
    },
]
